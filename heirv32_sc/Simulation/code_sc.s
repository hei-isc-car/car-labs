...
main:
	# Time a bit before reading buttons again, near 63.55 ms @ 66 MHz
	#   x1 is i
	#   x20 is target, count to arnd. ((1'048'576 * 4) - 2)*1 (4 instr. in loop, the last only 2, *1 clocks by instr)
	#   x2 is slt res.
